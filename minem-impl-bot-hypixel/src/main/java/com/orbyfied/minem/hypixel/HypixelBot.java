...
import com.orbyfied.minem.auth.MinecraftAccount;
import com.orbyfied.minem.auth.ClientAuthenticator;
import com.orbyfied.minem.chat.ClientChatHandler;
import com.orbyfied.minem.player.LocalPlayer;
import com.orbyfied.minem.event.Chain;
import com.orbyfied.minem.hypixel.command.HypixelCommand;
import com.orbyfied.minem.hypixel.command.HypixelCommandContext;
import com.orbyfied.minem.hypixel.storage.HypixelBotStorage;
import com.orbyfied.minem.hypixel.storage.MapAccess;
import com.orbyfied.minem.hypixel.util.HypixelChatUtils;
...
public class HypixelBot extends ClientComponent {
    ...
    protected boolean attach(MinecraftClient client) {
        ...
        client.onStateSwitch().addLast((oldState, newState) -> {
            if (newState == ClientState.INACTIVE) {
...
//        String ign = reader.collect(c -> (c >= 'a' && c <= 'z') || (c >= 'A' && c <= 'Z') || c == '_' || (c >= '0' && c <= '9'));
    ...
    public static class HypixelChat {
        ...
        public String ignRanked;
        public String ignStripped;
        public Type type;
    ...
    public void send(Channel channel, String str, boolean unique) {
        String cmd = null;
        switch (channel) {
            case ALL: cmd = "/ac"; break;
            case PRIVATE: cmd = "/r"; break;
            case GUILD: cmd = "/gc"; break;
            case PARTY: cmd = "/pc"; break;
        };
    ...
    @AllArgsConstructor
    @Getter
    public static class SendableResult {
