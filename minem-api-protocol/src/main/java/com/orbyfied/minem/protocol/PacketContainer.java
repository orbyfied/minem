...
public class PacketContainer {
    ...
    public PacketContainer source(PacketSource source) {
        this.source = source;
        return this;
    }
    ...
    public PacketContainer withData(Object data) {
        this.data = data;
        return this;
    }

    public PacketContainer set(int flag) {
        flags |= flag;
        return this;
    }

    public PacketContainer clear(int flag) {
        flags &= ~flag;
        return this;
    }

    public PacketContainer cancel(boolean b) {
        if (b) set(CANCEL);
        else clear(CANCEL);
        return this;
    }
