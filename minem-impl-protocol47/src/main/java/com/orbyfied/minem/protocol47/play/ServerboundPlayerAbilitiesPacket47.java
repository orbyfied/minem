...
import com.orbyfied.minem.protocol.play.ServerboundPlayerAbilitiesPacket;
...
public class ServerboundPlayerAbilitiesPacket47 {
    ...
    public static void write(ServerboundPlayerAbilitiesPacket packet, PacketContainer container, UnsafeByteBuf buf) {
        // todo
    }

    public static void read(ServerboundPlayerAbilitiesPacket packet, PacketContainer container, UnsafeByteBuf buf) {
